...
Version  : 2.93.4
Release  : 53
URL      : https://download.blender.org/source/blender-2.93.4.tar.xz
Source0  : https://download.blender.org/source/blender-2.93.4.tar.xz
...
%prep
%setup -q -n blender-2.93.4
cd %{_builddir}/blender-2.93.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630519884
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/blender-2.93.4/COPYING %{buildroot}/usr/share/package-licenses/blender/002c2409e6067c4266c849727f3fc57978f4a2b5
cp %{_builddir}/blender-2.93.4/doc/license/BSD-3-Clause-license.txt %{buildroot}/usr/share/package-licenses/blender/6167dbf96cbf9e18895b6d383f51844e5d110f55
cp %{_builddir}/blender-2.93.4/doc/license/GPL-license.txt %{buildroot}/usr/share/package-licenses/blender/83b54b10518c3d114a1ff5ea7e2653a20d9d3458
cp %{_builddir}/blender-2.93.4/doc/license/GPL3-license.txt %{buildroot}/usr/share/package-licenses/blender/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/blender-2.93.4/extern/audaspace/LICENSE %{buildroot}/usr/share/package-licenses/blender/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/blender-2.93.4/extern/ceres/LICENSE %{buildroot}/usr/share/package-licenses/blender/c2714fada57efd120de5f1229e46eaf87cf0a16e
cp %{_builddir}/blender-2.93.4/extern/cuew/LICENSE %{buildroot}/usr/share/package-licenses/blender/d2bf36877185a0d9b2baf0450ef8f0e01be1125d
cp %{_builddir}/blender-2.93.4/extern/draco/draco/LICENSE %{buildroot}/usr/share/package-licenses/blender/1128f8f91104ba9ef98d37eea6523a888dcfa5de
cp %{_builddir}/blender-2.93.4/extern/gflags/COPYING.txt %{buildroot}/usr/share/package-licenses/blender/b2d4ab17f1b8ef9e0646ba932dce81efe3b852ab
cp %{_builddir}/blender-2.93.4/extern/glew-es/LICENSE.txt %{buildroot}/usr/share/package-licenses/blender/0ca22faedb8ee495473a82c4d91452493b22ac9f
cp %{_builddir}/blender-2.93.4/extern/glew/LICENSE.txt %{buildroot}/usr/share/package-licenses/blender/0ca22faedb8ee495473a82c4d91452493b22ac9f
cp %{_builddir}/blender-2.93.4/extern/glog/COPYING %{buildroot}/usr/share/package-licenses/blender/43c9d4e201bf773d965455b593cd8a244d98564b
cp %{_builddir}/blender-2.93.4/extern/gmock/LICENSE %{buildroot}/usr/share/package-licenses/blender/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/blender-2.93.4/extern/gtest/LICENSE %{buildroot}/usr/share/package-licenses/blender/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/blender-2.93.4/extern/lzo/minilzo/COPYING %{buildroot}/usr/share/package-licenses/blender/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/blender-2.93.4/extern/mantaflow/LICENSE %{buildroot}/usr/share/package-licenses/blender/6596d7deb814bf619e0b2c0a7c29dbb3b9f8f43e
cp %{_builddir}/blender-2.93.4/extern/quadriflow/3rd/lemon-1.3.1/LICENSE %{buildroot}/usr/share/package-licenses/blender/b34f205f74c018d0d5b8c116015f58df92375a11
cp %{_builddir}/blender-2.93.4/extern/quadriflow/LICENSE.txt %{buildroot}/usr/share/package-licenses/blender/86241cf770af908f25bb6be748d736dda1e3cd44
cp %{_builddir}/blender-2.93.4/intern/numaapi/LICENSE %{buildroot}/usr/share/package-licenses/blender/50159ef1fd8035c7dd7e2e9aa9d6e34adc2eaf54
cp %{_builddir}/blender-2.93.4/release/datafiles/studiolights/matcap/license.txt %{buildroot}/usr/share/package-licenses/blender/faddfe17fb1306925298bb760341d43212999be4
cp %{_builddir}/blender-2.93.4/release/datafiles/studiolights/world/license.txt %{buildroot}/usr/share/package-licenses/blender/8e278c84a1bf9b2df9c1ee407349c4634f104777
cp %{_builddir}/blender-2.93.4/release/license/GPL-license.txt %{buildroot}/usr/share/package-licenses/blender/aa84cb217f40293d65b82d5b5947bd0c77e63fd3
cp %{_builddir}/blender-2.93.4/release/text/copyright.txt %{buildroot}/usr/share/package-licenses/blender/823ab2688ac7fe2082b9d53afd9ebb2122aeb337
pushd clr-build
%make_install
popd
%find_lang blender
